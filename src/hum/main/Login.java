...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setForeground(new java.awt.Color(101, 143, 255));
        jLabel2.setText("HR Glance");
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 200, 50));
        ...
        jPanel5.add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 300, 30));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Username");
        jPanel5.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, -1, 30));

        cbUsertype.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        cbUsertype.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "HR Manager", "Employee" }));
        jPanel5.add(cbUsertype, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 300, 30));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Usertype");
        jPanel5.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, -1, 30));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Password");
        jPanel5.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, -1, 30));
        ...
        jPanel5.add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 320, -1, 30));

        txtPassword.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel5.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, 300, 30));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            ...
            if(rs != null && rs.next()) {
                ...
                new Message(this, "ERROR", "Username / Password is incorrect").setVisible(true);
            }
        } catch (HeadlessException | SQLException e) {
            System.out.println(e);
            new Message(this, "ERROR", e.toString()).setVisible(true);
        }
